...
describe("loadRuleFiles", () => {
	...
	it("should use .kilocode-chinese/rules/ directory when it exists and has files", async () => {
		...
		statMock.mockImplementation((path) => {
			...
			if (
				normalizedPath.includes("/fake/path/.kilocode-chinese/rules/file1.txt") ||
				normalizedPath.includes("/fake/path/.kilocode-chinese/rules/file2.txt")
			) {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/file2.txt") {
		...
		const expectedPath1 =
			process.platform === "win32"
				...
				: "/fake/path/.kilocode-chinese/rules/file1.txt"
		const expectedPath2 =
			process.platform === "win32"
				? "\\fake\\path\\.kilocode\\rules\\file2.txt"
				: "/fake/path/.kilocode-chinese/rules/file2.txt"
	...
	it("should fall back to .kilocoderules when .kilocode-chinese/rules/ is empty", async () => {
		// Simulate .kilocode/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .kilocode-chinese/rules/", async () => {
		// Simulate .kilocode/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.kilocode-chinese/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.kilocode-chinese/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/subdir/subdir2/nested2.txt") {
		...
		const expectedRootPath =
			process.platform === "win32"
				...
				: "/fake/path/.kilocode-chinese/rules/root.txt"
		const expectedNested1Path =
			process.platform === "win32"
				? "\\fake\\path\\.kilocode\\rules\\subdir\\nested1.txt"
				: "/fake/path/.kilocode-chinese/rules/subdir/nested1.txt"
		const expectedNested2Path =
			process.platform === "win32"
				? "\\fake\\path\\.kilocode\\rules\\subdir\\subdir2\\nested2.txt"
				: "/fake/path/.kilocode-chinese/rules/subdir/subdir2/nested2.txt"
...
describe("Rules directory reading", () => {
	it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
			...
			.mockResolvedValueOnce([
				{
					...
					isFile: () => true,
					parentPath: "/fake/path/.kilocode-chinese/rules/symlink-target-dir",
				},
			] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/regular.txt") {
			...
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/symlink-target-dir/subdir_link.txt") {
		...
		const expectedRegularPath =
			process.platform === "win32"
				...
				: "/fake/path/.kilocode-chinese/rules/regular.txt"
		...
		const expectedSubdirPath =
			process.platform === "win32"
				...
				: "/fake/path/.kilocode-chinese/rules/symlink-target-dir/subdir_link.txt"
		...
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.kilocode-chinese/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.kilocode-chinese/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.kilocode-chinese/rules/regular.txt", "utf-8")
	...
	it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
		...
		statMock.mockImplementation((path) => {
			...
			expect([
				"/fake/path/.kilocode-chinese/rules/file1.txt",
				"/fake/path/.kilocode-chinese/rules/file2.txt",
				"/fake/path/.kilocode-chinese/rules/file3.txt",
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.kilocode-chinese/rules/file3.txt") {
