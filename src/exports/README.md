...
3. Get access to the API with the following code:
    ...
    ```ts
    const clineExtension = vscode.extensions.getExtension<ClineAPI>("shengsuan-cloud.kilo-ssy")
    ...
    **Note:** To ensure that the `shengsuan-cloud.kilo-ssy` extension is activated before your extension, add it to the `extensionDependencies` in your `package.json`:

    ```json
    "extensionDependencies": [
        "shengsuan-cloud.kilo-ssy"
    ]
    ```
