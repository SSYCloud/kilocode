	...
	return (
		<SelectPrimitive.Trigger
			...
			<SelectPrimitive.Icon asChild>
				<lucide_react_1.ChevronDown className="size-4 opacity-50" />
		...
		<SelectPrimitive.Item
			...
			<span className="absolute right-2 flex size-3.5 items-center justify-center">
				<SelectPrimitive.ItemIndicator>
					<lucide_react_1.Check className="text-accent group-focus:text-accent-foreground size-4" />
				</SelectPrimitive.ItemIndicator>
			</span>
...
function SelectScrollUpButton(_a) {
	...
	return (
		<SelectPrimitive.ScrollUpButton
			...
			{...props}>
			<lucide_react_1.ChevronUp className="size-4" />
		</SelectPrimitive.ScrollUpButton>
	)
}
function SelectScrollDownButton(_a) {
	...
	return (
		<SelectPrimitive.ScrollDownButton
			...
			className={(0, utils_1.cn)("flex cursor-default items-center justify-center py-1", className)}
			{...props}>
			<lucide_react_1.ChevronDown className="size-4" />
		</SelectPrimitive.ScrollDownButton>
	)
}
