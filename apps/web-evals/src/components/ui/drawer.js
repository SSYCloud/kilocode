...
function DrawerHeader(_a) {
	...
	return (
		<div
			...
			className={(0, utils_1.cn)("flex flex-col gap-1.5 py-4", className)}
			{...props}
		/>
	)
}
function DrawerFooter(_a) {
	...
	return (
		<div
			...
			className={(0, utils_1.cn)("mt-auto flex flex-col gap-2 py-4", className)}
			{...props}
		/>
	)
}
function DrawerTitle(_a) {
	...
	return (
		<vaul_1.Drawer.Title
			...
			className={(0, utils_1.cn)("text-foreground font-semibold", className)}
			{...props}
		/>
	)
}
