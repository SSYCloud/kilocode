...
function CommandDialog(_a) {
	var _b = _a.title,
		title = _b === void 0 ? "Command Palette" : _b,
		_c = _a.description,
		description = _c === void 0 ? "Search for a command to run..." : _c,
		children = _a.children,
		props = __rest(_a, ["title", "description", "children"])
	return (
...
function CommandList(_a) {
	...
	return (
		<cmdk_1.Command.List
			...
			className={(0, utils_1.cn)("max-h-[300px] scroll-py-1 overflow-x-hidden overflow-y-auto", className)}
			{...props}
		/>
	)
}
function CommandEmpty(_a) {
	var props = __rest(_a, [])
	return <cmdk_1.Command.Empty data-slot="command-empty" className="py-6 text-center" {...props} />
}
...
function CommandSeparator(_a) {
	...
	return (
		<cmdk_1.Command.Separator
			...
			className={(0, utils_1.cn)("bg-accent/5 -mx-1 h-px", className)}
			{...props}
		/>
	)
}
