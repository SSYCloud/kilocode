...
function AlertDialogHeader(_a) {
	...
	return (
		<div
			...
			className={(0, utils_1.cn)("flex flex-col gap-2 text-center sm:text-left", className)}
			{...props}
		/>
	)
}
function AlertDialogFooter(_a) {
	...
	return (
		<div
			...
			className={(0, utils_1.cn)("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", className)}
			{...props}
		/>
	)
}
...
function AlertDialogCancel(_a) {
	...
	return (
		<AlertDialogPrimitive.Cancel
			className={(0, utils_1.cn)((0, button_1.buttonVariants)({ variant: "outline" }), className)}
			{...props}
		/>
	)
}
